...
<label><font size="5"><u><center>Laporan Data Pembelian</center></u></font></label>
...
<table style="border: 1px solid gray;" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<th style="border-right: 1px solid gray">Supplier</th>
		<th style="border-right: 1px solid gray">Harga</th>
		<th style="border-right: 1px solid gray">Kondisi</th>
	</tr>
	...
	<?php
		...
		<tr>
			...
			<td style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[supplier]"; ?></td>
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[harga]"; ?></td>
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[kondisi]"; ?></td>
		</tr>
	<?php $no++;	}
	?>
